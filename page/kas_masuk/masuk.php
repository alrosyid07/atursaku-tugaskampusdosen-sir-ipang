            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header bg-primary">
                        <h2 style="color: white;">Data Kas Masuk</h2>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="masuk">
                                <div class="btn-ex">        
                            <a href="page/kas_masuk/laporan_excel.php"  class="btn btn-secondary  " tabindex="0" aria-controls="rekap" ><span>Excel</span></a> 
                            <a href="page/kas_masuk/laporan_csv.php" class="btn btn-secondary  " tabindex="0" aria-controls="rekap" ><span>CSV</span></a> 
                            <!-- <a href="page/kas_masuk/laporan_pdf.php" class="btn btn-secondary  " tabindex="0" aria-controls="rekap" ><span>PDF</span></a>  -->
                            <a  href="page/kas_masuk/laporan.php" target="blank" class="btn btn-secondary " tabindex="0" aria-controls="rekap" ><span>Laporan</span></a> 
                        </div>
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                ...
                                ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <button style="color: white;" id="edit_data" data-toggle="modal" data-target="#edit" data-id="<?php echo $data['kode']; ?>" data-ket="<?php echo $data['keterangan']; ?>" data-tgl="<?php echo $data['tgl']; ?>" data-jml="<?php echo $data['jumlah']; ?>" class="btn btn-warning btn-md" title="Ubah Data"><i class="fa fa-pencil"> </i></button>
